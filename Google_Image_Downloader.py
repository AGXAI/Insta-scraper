...
# Create a directory named after the search query if it doesn't exist
download_path = os.path.join(os.getcwd(), search_query.replace(' ', '_'))
...
urls = get_images_from_google(driver, 2, number_of_images)
